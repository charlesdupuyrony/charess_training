...
/* harmony import */ var _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/material/sidenav */ 94935);
...
class TaskComponent {
    ...
    createFormGroup(data) {
        return this.fb.group({
            ...
            due_date: [
                (0,_angular_common__WEBPACK_IMPORTED_MODULE_3__.formatDate)(data ? data.due_date : (0,_angular_common__WEBPACK_IMPORTED_MODULE_3__.formatDate)(new Date(), 'yyyy-MM-dd', 'en') || '', 'yyyy-MM-dd', 'en')
            ],
...
TaskComponent.ɵfac = function TaskComponent_Factory(t) { return new (t || TaskComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__.FormBuilder)); };
...
//# sourceMappingURL=src_app_task_task_module_ts-es2015.js.map