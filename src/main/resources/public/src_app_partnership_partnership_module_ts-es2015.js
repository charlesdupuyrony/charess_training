...
const routes = [
    ...
    {
        path: 'request',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_partnership_request_request_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./request/request.module */ 10619)).then((m) => m.RequestModule),
    },
];
