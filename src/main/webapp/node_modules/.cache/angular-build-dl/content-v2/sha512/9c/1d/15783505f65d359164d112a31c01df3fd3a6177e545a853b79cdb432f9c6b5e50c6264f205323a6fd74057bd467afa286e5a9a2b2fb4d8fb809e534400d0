  ...
  (self["webpackChunksmart"] = self["webpackChunksmart"] || []).push([["main"], {
      ...
      var routes = [{
        ...
        }, // Extra components
        {
          ...
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() */
            [__webpack_require__.e("default-node_modules_angular_material___ivy_ngcc___fesm2015_select_js"), __webpack_require__.e("default-node_modules_angular_material___ivy_ngcc___fesm2015_snack-bar_js"), __webpack_require__.e("default-node_modules_angular_material___ivy_ngcc___fesm2015_paginator_js-node_modules_angular-7ead80"), __webpack_require__.e("src_app_tables_tables_module_ts")]).then(__webpack_require__.bind(__webpack_require__,
      ...
      var _AuthService = /*#__PURE__*/function () {
        ...
        _createClass(_AuthService, [{
          ...
          value: function login(credentials) {
            ...
            return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.auth, data, {
              headers: {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function HeaderComponent_a_26_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](2, "span", 42);
      ...
      function HeaderComponent_a_36_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](6, "span", 47);

          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](7, "i", 48);
      ...
      _HeaderComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
        ...
        template: function HeaderComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](9, "Smart");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](68, "button", 37);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](69, "mat-icon", 38);
        ...
        directives: [_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__.NgbNavbar, _angular_router__WEBPACK_IMPORTED_MODULE_8__.RouterLinkWithHref, _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__.NgbCollapse, _angular_material_button__WEBPACK_IMPORTED_MODULE_10__.MatButton, _angular_material_icon__WEBPACK_IMPORTED_MODULE_11__.MatIcon, _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__.NgbDropdown, _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__.NgbDropdownToggle, _angular_common__WEBPACK_IMPORTED_MODULE_7__.NgIf, _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__.NgbDropdownMenu, _angular_common__WEBPACK_IMPORTED_MODULE_7__.NgForOf, ngx_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_12__.PerfectScrollbarDirective, _angular_common__WEBPACK_IMPORTED_MODULE_7__.NgClass],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _RightSidebarComponent = /*#__PURE__*/function (_src_app_shared_Unsub2) {
        ...
        function _RightSidebarComponent(document, renderer, elementRef, rightSidebarService, configService) {
          ...
          _this12.rightSidebarService = rightSidebarService;
          _this12.configService = configService;
          _this12.selectedBgColor = 'white';
          _this12.showpanel = false;
          _this12.isDarkSidebar = false;
          _this12.isDarTheme = false;
          _this12.isRtl = false;
          _this12.config = {};
          return _this12;
        }
        ...
        _createClass(_RightSidebarComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.config = this.configService.configData;
            this.subs.sink = this.rightSidebarService.sidebarState.subscribe(function (isRunning) {
              _this13.isOpenSidebar = isRunning;
            });
          ...
          this.routerObj = this.router.events.subscribe(function (event) {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_4__.NavigationEnd) {
              ...
              if (role.indexOf(firstString) !== -1) {
                _this14.level1Menu = currenturl.split('/')[2];
                _this14.level2Menu = currenturl.split('/')[3];
              } else {
                _this14.level1Menu = currenturl.split('/')[1];
                _this14.level2Menu = currenturl.split('/')[2];
              } // close sidebar on mobile screen after menu select


              _this14.renderer.removeClass(_this14.document.body, 'overlay-open');
            }
          });
        }
        ...
        _createClass(_SidebarComponent, [{
          ...
          value: function logout() {
            ...
            this.authService.logout().subscribe(function (res) {
              if (!res.success) {
                _this15.router.navigate(['/authentication/signin']);
              }
            });
          }
        }]);
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _environment = {
        ...
        auth: 'http://localhost:8080/api/authentication'
      };
      /*
