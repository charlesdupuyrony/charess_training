...
/* harmony export */   "RequestFormComponent": function() { return /* binding */ RequestFormComponent; }
/* harmony export */ });
...
function RequestFormComponent_mat_option_23_Template(rf, ctx) { if (rf & 1) {
...
function RequestFormComponent_mat_error_25_Template(rf, ctx) { if (rf & 1) {
...
function RequestFormComponent_mat_error_38_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpipe"](2, "translate");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
...
function RequestFormComponent_mat_option_46_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-option", 25);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function RequestFormComponent_mat_error_47_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpipe"](2, "translate");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
...
function RequestFormComponent_mat_error_54_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpipe"](2, "translate");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
...
class RequestFormComponent {
    ...
    // isEmailDuplicated = [];
    // msg: string;
    constructor(fb, service, snack, router) {
        this.fb = fb;
    ...
    ngOnInit() {
        ...
        this.topics = this.topic.valueChanges.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.startWith)(''), (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.map)(value => {
    ...
    submit(ob) {
        ...
        this.service.save(ob).subscribe((res) => this.success(res), (err) => this.error(err));
    }
}
...
RequestFormComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: RequestFormComponent, selectors: [["app-form"]], decls: 62, vars: 35, consts: [[1, "content"], [1, "container-fluid"], [1, "block-header"], [1, "row"], [1, "col-xs-12", "col-sm-12", "col-md-12", "col-lg-12"], [1, "page-title"], [1, "row", "clearfix"], [1, "card"], [1, "body"], [3, "formGroup", "submit"], [1, "col-12"], ["appearance", "outline", 1, "example-full-width"], ["type", "text", "matInput", "", "required", "", 3, "formControl", "matAutocomplete"], ["autoActiveFirstOption", "", 3, "displayWith"], ["auto", "matAutocomplete"], [3, "value", 4, "ngFor", "ngForOf"], [4, "ngIf"], [1, "col-3"], [3, "rangePicker"], ["required", "", "matStartDate", "", "formControlName", "startDate", "placeholder", "From Date"], ["required", "", "matEndDate", "", "formControlName", "endDate", "placeholder", "To Date"], ["matSuffix", "", 3, "for"], ["picker", ""], [1, "col-6"], ["required", "true", "formControlName", "attendeeCategory", 3, "compareWith"], [3, "value"], ["type", "number", "matInput", "", "formControlName", "numberOfAttendees", "required", ""], [1, "col-xl-12", "col-lg-12", "col-md-12", "col-sm-12", "mb-2"], [1, "example-button-row"], ["mat-raised-button", "", "color", "primary", 3, "type", "disabled"]], template: function RequestFormComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("submit", function RequestFormComponent_Template_form_submit_13_listener() { return ctx.submit(ctx.fg.value); });
...
/* harmony import */ var _form_request_form_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./form/request.form.component */ 26334);
...
/* harmony import */ var _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @angular/material/toolbar */ 12522);
...
/* harmony import */ var _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @swimlane/ngx-datatable */ 38550);
...
/* harmony import */ var _request_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./request-routing.module */ 30059);
/* harmony import */ var _form_request_form_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./form/request.form.component */ 26334);
/* harmony import */ var _core_service_training_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../core/service/training.service */ 29744);
...
RequestModule.ɵmod = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineNgModule"]({ type: RequestModule });
RequestModule.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjector"]({ providers: [
        _core_service_training_service__WEBPACK_IMPORTED_MODULE_2__.TrainingService
    ], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](RequestModule, { declarations: [_form_request_form_component__WEBPACK_IMPORTED_MODULE_1__.RequestFormComponent], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
        _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
        _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule,
        _angular_material_table__WEBPACK_IMPORTED_MODULE_6__.MatTableModule,
        _angular_material_paginator__WEBPACK_IMPORTED_MODULE_7__.MatPaginatorModule,
...
//# sourceMappingURL=src_app_partnership_request_request_module_ts-es2015.js.map