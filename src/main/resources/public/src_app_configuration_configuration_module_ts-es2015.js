...
const routes = [
    {
        path: 'topic',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_configuration_topic_topic_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./topic/topic.module */ 46447)).then((m) => m.TopicModule),
    },
    {
        path: 'institution',
